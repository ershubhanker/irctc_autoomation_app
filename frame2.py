...
log_obj = logging_module.setup_logger("frame22")
...
def start2(user2,user2_pass,passanger_value,upi_value,method_pay,debit_value):
    ...
    options.add_argument(f'--user-data-dir={var}\chrome\chromedata2')
    ...
    try:
        ...
        def upi_function():
            ...
            diff.seconds/60 
            print('Total time taken for second browser :',diff)
            log_obj.info(diff)
        #select debit
        def debit_function():
            #continue button same for both
