...
def start2(user2,user2_pass,passanger_value,upi_value,method_pay,debit_value):
    ...
    try:    
        ...
        os.system(f'start cmd /k "brave.exe --remote-debugging-port=9222 --user-data-dir={var}\chrome\chromedata2"')
    ...
    try:
        ...
        print('page 2 not reload, Unable to locate element login button  ')
        driver.close()
    try:
        ...
        def  logincaptcha():
            ...
            im = Image.open(f"{var}\logo2.png") #use PIL.Image.open if not work
            left = 0
            top = 250
            right = 300
            bottom = 270
        ...
        try:
            if driver.find_element(By.XPATH, '//*[@id="divMain"]/div/app-train-list/div[4]/div/div[5]/div[1]/div[1]/app-train-avl-enq/div[2]/div/span/span[1]/button').is_enabled()==True:
                ...
                messagebox.showerror('booking error','train cancelled or confirm train route on website  ')
                # quit()
        ...
        print('2 something went wrong login again',e)
