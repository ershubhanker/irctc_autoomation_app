...
<<<<<<< HEAD
        ...
        try:
            if driver.find_element(By.XPATH, '//*[@id="divMain"]/div/app-train-list/div[4]/div/div[5]/div[1]/div[1]/app-train-avl-enq/div[2]/div/span/span[1]/button').is_enabled()==True:
                ...
                messagebox.showerror('booking error','train cancelled or confirm train route ')
                # quit()
                ...
                try:
                    for i in range(3):
                        ...
                        try:
                            if driver.find_element(By.ID, "nlpImgContainer").is_displayed()==True: 
                                print("enter agian ")
                                cross = driver.find_element(By.XPATH, '//*[@id="divMain"]/div/app-review-booking/p-toast/div/p-toastitem/div/div/a')
                                cross.click()
        ...
        def debit_function():
            ...
            def paycaptcha2():
                ...
                with open(f"{var}\logo.png", "rb") as image_file:
                    ...
                    data = response.json()
                    captcha=data['result']
                    print('debiit 1 captcha:',captcha)
        ...
        print('1 something went wrong login again',e)
