...
const getFilePixel = (title) => {
    ...
    if (title) {
        ...
        let pixels = ["240p", "360p", "480p", "720p", "1080p", "2160p", "4k"];
...
const getFileLanguage = (title) => {
    ...
    let langArr = ["en", "english", "english dubbed", "eng", "fr", "french", "it", "italian", "es", "spanish", "esp", "jpn", "multi-sub", "subs", "multi", "japanese", "multiple subtitle", "chinese", "eng-sub", "esubs", "hindi + eng", "portuguese", "english subs", "eng subs", "ag", "mx"];
